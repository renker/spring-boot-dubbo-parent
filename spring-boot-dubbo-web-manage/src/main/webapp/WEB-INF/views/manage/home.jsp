        ...
        <div class="tab-pane active" id="rp-alluser">
            ...
            <ul class="chatuserlist">
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx}/static/lib/manage/images/photos/userprofile.png" class="media-object">
                        </a>
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx}/static/lib/manage/images/photos/user1.png" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx}/static/lib/manage/images/photos/user2.png" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx}/static/lib/manage/images/photos/user3.png" class="media-object">
                        </a>
                        <div class="media-body">
                ...
                <li class="online">
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx}/static/lib/manage/images/photos/user4.png" class="media-object">
                        </a>
                        <div class="media-body">
            ...
            <ul class="chatuserlist">
                <li>
                    <div class="media">
                        <a href="#" class="pull-left media-thumb">
                            <img alt="" src="${ctx}/static/lib/manage/images/photos/user5.png" class="media-object">
                        </a>
                        <div class="media-body">
                            <strong>Eileen Sideways</strong>
                            <small>Los Angeles, CA</small>
